*** Settings ***
Documentation    M1M3 Hardpoint Actuator and Force Actuator Telemetry tests.
Force Tags    
...
Verify Force Actuator Info Event - ActuatorType
    [Tags]    functional
    Comment    ActuatorType is set by the M1M3_Simulator.YYYYYYY keyword, ZZZZZZZZ parameter.
    Verify Rational Array    ${faidata}    ActuatorType    ${A}    ${A}    ${A}    ${A}    ${A}    ${A}

Verify Force Actuator Info Event - ActuatorOrientation
    [Tags]    functional
    Comment    ActuatorOrientation is set by the M1M3_Simulator.YYYYYYY keyword, ZZZZZZZZ parameter.
    Verify Rational Array    ${faidata}    ActuatorOrientation    ${A}    ${A}    ${A}    ${A}    ${A}    ${A}
...
Verify Force Actuator Info Event - ILCApplicationType
    [Tags]    functional
    Comment    ILCApplicationType is set by the M1M3_Simulator.YYYYYYY keyword, ilcAppType parameter.
    Verify Rational Array    ${faidata}    ILCApplicationType    ${7}    ${7}    ${7}    ${7}    ${7}    ${7}

Verify Force Actuator Info Event - ILCUniqueId
    [Tags]    functional.
    Comment    ILCUniqueId is set by the M1M3_Simulator.YYYYYYY keyword, uniqueId parameter.
    Verify Rational Array    ${faidata}    ILCUniqueId    ${11}    ${12}    ${13}    ${14}    ${15}    ${16}

Verify Force Actuator Info Event - ILCSelectedOptions
    [Tags]    functional
    Comment    ILCSelectedOptions is set by the M1M3_Simulator.YYYYYYY keyword, ZZZZZZZZ parameter.
    Verify Rational Array    ${faidata}    ILCSelectedOptions    ${A}    ${A}    ${A}    ${A}    ${A}    ${A}
...
Verify Force Actuator Info Event - MajorRevision
    ...
    Verify Rational Array    ${faidata}    MajorRevision    ${8}    ${8}    ${8}    ${8}    ${8}    ${8}
...
Verify Force Actuator Info Event - MinorRevision
    ...
    Verify Rational Array    ${faidata}    MinorRevision    ${0}    ${0}    ${0}    ${0}    ${0}    ${0}
...
Verify Force Actuator Info Event - MezzanineFirmwareType
    ...
    Verify Rational Array    ${faidata}    MezzanineFirmwareType    ${54}    ${54}    ${54}    ${54}    ${54}    ${54}
...
Verify Force Actuator Info Event - MezzanineMajorRevision
    ...
    Verify Rational Array    ${faidata}    MezzanineMajorRevision    ${8}    ${8}    ${8}    ${8}    ${8}    ${8}
...
Verify Force Actuator Info Event - MezzanineMinorRevision
    ...
    Verify Rational Array    ${faidata}    MezzanineMinorRevision    ${2}    ${2}    ${2}    ${2}    ${2}    ${2}
...
Verify Force Actuator Info Event - MezzanineUniqueId
    ...
    Verify Rational Array    ${faidata}    MezzanineUniqueId    ${1007}    ${1008}    ${1009}    ${1010}    ${1011}    ${1012}
...
Verify Force Actuator Info Event - ModbusAddress
    ...
    Verify Rational Array    ${faidata}    ModbusAddress    ${84}    ${85}    ${86}    ${87}    ${88}    ${89}
...
Verify Force Actuator Info Event - ModbusSubnet
    ...
    Verify Rational Array    ${faidata}    ModbusSubnet    ${5}    ${5}    ${5}    ${5}    ${5}    ${5}

Verify Force Actuator Info Event - NetworkNodeType
    [Tags]    functional
    Comment    NetworkNodeType is set by the M1M3_Simulator.YYYYYYY keyword, networkNodeType parameter.
    Verify Rational Array    ${faidata}    NetworkNodeType    ${7}    ${7}    ${7}    ${7}    ${7}    ${7}

Verify Force Actuator Info Event - NetworkNodeOptions
    [Tags]    functional
    Comment    NetworkNodeOptions is set by the  M1M3_Simulator.YYYYYYY keyword, ZZZZZZZZ parameter.
    Verify Rational Array    ${faidata}    NetworkNodeOptions    ${A}    ${A}    ${A}    ${A}    ${A}    ${A}
...
Verify Force Actuator Info Event - XPosition
    [Tags]    functional
    Comment    XPosition
    Verify Rational Array    ${faidata}    XPosition    ${A}    ${A}    ${A}    ${A}    ${A}    ${A}

Verify Force Actuator Info Event - YPosition
    [Tags]    functional
    Comment    data.YPosition is set by the  M1M3_Simulator.YYYYYYY keyword, ZZZZZZZZ parameter.
    Verify Rational Array    ${faidata}    YPosition    ${A}    ${A}    ${A}    ${A}    ${A}    ${A}

Verify Force Actuator Info Event - ZPosition
    [Tags]    functional
    Comment    data.ZPosition is set by the  M1M3_Simulator.YYYYYYY keyword, ZZZZZZZZ parameter.
    Verify Rational Array    ${faidata}    ZPosition    ${A}    ${A}    ${A}    ${A}    ${A}    ${A}
...
Set Hardpoint AzimuthForcesApplied LVDTs - Parked
    [Tags]    functional
    Set Hardpoint AzimuthForcesApplied LVDT    ${84}   ${-67.7013}    ${-32.0664}
    Set Hardpoint AzimuthForcesApplied LVDT    ${85}   ${80.8065}    ${30.7562}
    Set Hardpoint AzimuthForcesApplied LVDT    ${86}   ${-779.3144}    ${381.2256}
    Set Hardpoint AzimuthForcesApplied LVDT    ${87}   ${691.2441}    ${-603.9484}
    Set Hardpoint AzimuthForcesApplied LVDT    ${88}   ${261.4818}    ${-859.8013}
    Set Hardpoint AzimuthForcesApplied LVDT    ${89}   ${-553.3500}    ${-390.1598}
...
Set Hardpoint AzimuthForcesApplied LVDTs - Raising
    [Tags]    functional
    Set Hardpoint AzimuthForcesApplied LVDT    ${84}   ${6.2985}    ${3.2604}
    Set Hardpoint AzimuthForcesApplied LVDT    ${85}   ${-0.1147}    ${-3.9019}
    Set Hardpoint AzimuthForcesApplied LVDT    ${86}   ${3.8486}    ${8.2823}
    Set Hardpoint AzimuthForcesApplied LVDT    ${87}   ${-6.173}    ${0.1635}
    Set Hardpoint AzimuthForcesApplied LVDT    ${88}   ${-4.6194}    ${-8.9626}
    Set Hardpoint AzimuthForcesApplied LVDT    ${89}   ${-4.2489}    ${1.8729}
...
Set Hardpoint AzimuthForcesApplied LVDTs - Active
    [Tags]    functional
    Set Hardpoint AzimuthForcesApplied LVDT    ${84}   ${-6.356}    ${-1.7328}
    Set Hardpoint AzimuthForcesApplied LVDT    ${85}   ${-2.4262}    ${-1.4}
    Set Hardpoint AzimuthForcesApplied LVDT    ${86}   ${5.09}    ${0.0076}
    Set Hardpoint AzimuthForcesApplied LVDT    ${87}   ${2.9923}    ${7.498}
    Set Hardpoint AzimuthForcesApplied LVDT    ${88}   ${3.7093}    ${-6.7294}
    Set Hardpoint AzimuthForcesApplied LVDT    ${89}   ${2.6619}    ${-0.1038}
...
Set Hardpoint AzimuthForcesApplied LVDTs - Lowering
    [Tags]    functional
    Set Hardpoint AzimuthForcesApplied LVDT    ${84}   ${-4.0986}    ${-3.8844}
    Set Hardpoint AzimuthForcesApplied LVDT    ${85}   ${-5.6215}    ${-1.0793}
    Set Hardpoint AzimuthForcesApplied LVDT    ${86}   ${9.1817}    ${-3.5968}
    Set Hardpoint AzimuthForcesApplied LVDT    ${87}   ${-5.8255}    ${-9.6489}
    Set Hardpoint AzimuthForcesApplied LVDT    ${88}   ${-5.9124}    ${-4.1641}
    Set Hardpoint AzimuthForcesApplied LVDT    ${89}   ${6.3352}    ${9.444}
...
Set Hardpoint AzimuthForcesApplied LVDTs - ParkedEngineering
    [Tags]    functional
    Set Hardpoint AzimuthForcesApplied LVDT    ${84}   ${-5.7547}    ${-0.9152}
    Set Hardpoint AzimuthForcesApplied LVDT    ${85}   ${7.5998}    ${-5.3859}
    Set Hardpoint AzimuthForcesApplied LVDT    ${86}   ${-0.6323}    ${-3.6556}
    Set Hardpoint AzimuthForcesApplied LVDT    ${87}   ${1.4139}    ${-2.7282}
    Set Hardpoint AzimuthForcesApplied LVDT    ${88}   ${3.0318}    ${5.6386}
    Set Hardpoint AzimuthForcesApplied LVDT    ${89}   ${3.4932}    ${-5.2086}
...
Set Hardpoint AzimuthForcesApplied LVDTs - RaisingEngineering
    [Tags]    functional
    Set Hardpoint AzimuthForcesApplied LVDT    ${84}   ${6.5002}    ${-2.2664}
    Set Hardpoint AzimuthForcesApplied LVDT    ${85}   ${4.3867}    ${-0.4983}
    Set Hardpoint AzimuthForcesApplied LVDT    ${86}   ${-0.6658}    ${-4.9625}
    Set Hardpoint AzimuthForcesApplied LVDT    ${87}   ${2.8957}    ${6.1291}
    Set Hardpoint AzimuthForcesApplied LVDT    ${88}   ${-4.0986}    ${0.1223}
    Set Hardpoint AzimuthForcesApplied LVDT    ${89}   ${-8.0855}    ${-5.8437}
...
Set Hardpoint AzimuthForcesApplied LVDTs - ActiveEngineering
    [Tags]    functional
    Set Hardpoint AzimuthForcesApplied LVDT    ${84}   ${-7.1027}    ${-3.3515}
    Set Hardpoint AzimuthForcesApplied LVDT    ${85}   ${4.9707}    ${-4.0261}
    Set Hardpoint AzimuthForcesApplied LVDT    ${86}   ${-5.3761}    ${2.4002}
    Set Hardpoint AzimuthForcesApplied LVDT    ${87}   ${3.0922}    ${4.856}
    Set Hardpoint AzimuthForcesApplied LVDT    ${88}   ${3.1161}    ${6.8209}
    Set Hardpoint AzimuthForcesApplied LVDT    ${89}   ${7.2899}    ${-2.8102}
...
Set Hardpoint AzimuthForcesApplied LVDTs - LoweringEngineering
    [Tags]    functional
    Set Hardpoint AzimuthForcesApplied LVDT    ${84}   ${-3.2376}    ${-1.4411}
    Set Hardpoint AzimuthForcesApplied LVDT    ${85}   ${-6.7826}    ${3.0871}
    Set Hardpoint AzimuthForcesApplied LVDT    ${86}   ${-9.9491}    ${-6.4417}
    Set Hardpoint AzimuthForcesApplied LVDT    ${87}   ${1.9663}    ${9.0157}
    Set Hardpoint AzimuthForcesApplied LVDT    ${88}   ${-7.371}    ${-0.1022}
    Set Hardpoint AzimuthForcesApplied LVDT    ${89}   ${9.5657}    ${1.1736}
